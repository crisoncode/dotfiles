...
function checkCustomerByOrder(args) {
    ...
    if (order && order.orderNo) {
        ...
        Logger.info('Zerberus response -->  ' + JSON.stringify(zerberusServiceResult.object));
        ...
        while (ordersIterator.hasNext()) {
            ...
            if (zerberusCustomerObj && maxCallRetries > badHandleResults) {
                ...
                if (args.EnableZerberusLogs) {
                    Logger.info('OrderNo: ' + order.orderNo + ' with data --> ' + JSON.stringify(zerberusCustomerObj) + ' response --> ' + JSON.stringify(zerberusServiceResult.object));
                }
