...
describe('Helpers - Highlights', function () {
    ...
    describe('getAttributesByProductType function', function () {
        it('should return the attributes for a racket', function () {
            ...
            const mappingResult = highlightsHelper.getAttributesByProductType({ productType: 'racket' });
        ...
        it('should return the attributes for clothing', function () {
            ...
            assert.deepEqual(mappingResult.breathable.title, highlightsHelper.productAttributesToHighlight.moistureRepellent.clothing.breathable.title);
            assert.deepEqual(mappingResult.moistureRepellent.title, highlightsHelper.productAttributesToHighlight.moistureRepellent.clothing.moistureRepellent.title);
        });
    });
