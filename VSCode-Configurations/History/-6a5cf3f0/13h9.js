...
describe('Helpers - Highlights', function () {
    ...
    describe('getAttributesByProductType function', function () {
        it('should return the attributes for a racket', function () {
            ...
            assert.deepEqual(result.headSize.title, highlightsHelper.productAttributesToHighlight.headSize.title);
            assert.deepEqual(result.stringPattern.title, highlightsHelper.productAttributesToHighlight.stringPattern.title);
        });
    });
