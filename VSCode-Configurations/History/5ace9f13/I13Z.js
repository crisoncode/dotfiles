...
function fillAttributes(args) {
    ...
    Object.keys(args.attributesMapping).forEach((key) => {
        ...
        if (attrMap.enabled && attrMap.attributeID &&
            Object.prototype.hasOwnProperty.call(productCustomAttributes, attrMap.attributeID)) {
            attrMap.translationKey = key;
            attrMap.value = productCustomAttributes[attrMap.attributeID];
            attrMap.value = enhanceValuesWithMetrics(attrMap);
