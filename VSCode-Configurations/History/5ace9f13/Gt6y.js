...
function enhanceValuesWithMetrics(attribute, attributeValue) {
    ...
    if (attribute.key === 'weight') {
        value = Resource.msg('text.weightunstrung.unit', 'product', null, attributeValue);
    }

    if (attribute.key === 'headSize') {
        value = Resource.msg('text.headsize.unit', 'product', null, attributeValue);
    }

    if (attribute.key === 'balance') {
        value = Resource.msg('product.enhancement.balancePoint', null, attributeValue);
    }

    if (attribute.key === 'length') {
        value = Resource.msg('product.enhancement.length', null, attributeValue);
    }
    return value;
}
