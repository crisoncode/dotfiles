...
function enhanceValuesWithMetrics(attribute, attributeValue) {
    ...
    if (attribute.key === 'weight') {
        value = Resource.msg('text.weightunstrung.unit', 'product', attributeValue);
    }

    if (attribute.key === 'headSize') {
        value = Resource.msg('text.headsize.unit', 'product', attributeValue);
    }

    if (attribute.key === 'balance') {
        value = Resource.msg('product.enhancement.balancePoint', attributeValue);
    }

    if (attribute.key === 'length') {
        value = Resource.msg('product.enhancement.length', attributeValue);
    }
    return value;
}
