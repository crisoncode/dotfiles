...
const initSizeSelectorEvent = () => {
    ...
    if ($sizesSelectors.length > 0) {
        $(configurations.racketSize.eventListenerSelector).on('click', { buildVariationChoiceAjaxCall: variationsSelector.buildVariationChoiceAjaxCall(), test: 'cris' }, function (event) {
