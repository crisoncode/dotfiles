...
function showProductPage(querystring, res) {
    ...
    var test = ShippingMgr.getDefaultShippingMethod();
    var ProductShippingModel = ShippingMgr.getProductShippingModel(ProductMgr.getProduct(product.id));
    let resulting = ProductShippingModel.getShippingMethodsWithShippingCost();
