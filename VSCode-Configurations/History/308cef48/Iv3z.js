...
function switchPricebook(setNetPrice, country) {
    ...
    const employeePricebook = Site.getCurrent().getCustomPreferenceValue('employeePriceBookID') || '';
    const isEmployeePriceBookEnabled = Site.getCurrent().getCustomPreferenceValue('areEmployeePricesEnabled');
