...
function switchPricebook(setNetPrice, country) {
    ...
    const employeePricebookID = Site.getCurrent().getCustomPreferenceValue('employeePriceBookID') || 'EUR-Mitarbeiter-prices';
    const areEmployeePricesEnabled = Site.getCurrent().getCustomPreferenceValue('areEmployeePricesEnabled');
    ...
    */
    ...
    if (customer.isMemberOfCustomerGroup('TennisPointEmployee') && areEmployeePricesEnabled) {
...
function switchPricebookForBasket(basket) {
    ...
    } else if (customer.isMemberOfCustomerGroup('TennisPointEmployee') && areEmployeePricesEnabled) {
        switchPricebook(true);
